        ...
        <div class="container">
            <div class="result">
                <div class="col-md-12 py-3">
                    ...
                    <hr>
                    <h3>Form Buku</h3>
                    <a class="btn btn-secondary my-1" href='Buku.php'><i class=" fa fa-home"></i>Kembali</a>
                    <p></p>
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="penerbit" id="penerbit" <?php echo (isset($_GET['id_buku'])) ?  "value = '" . $result[0]["penerbit"] . "'" : "value = '' "; ?> placeholder="Masukkan Penerbit Buku" required>
                        </div>
                        <div class="mb-3">
